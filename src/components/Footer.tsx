...
export default function Footer() {
  return (
    <footer className="relative border-t-2 border-dashed border-rose-deep/20 py-8">
      <div className="mx-auto flex max-w-3xl flex-wrap items-center justify-between gap-4 px-4 text-sm text-ink/60 sm:px-6">
